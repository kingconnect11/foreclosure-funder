...
interface DealAnalyzerClientProps {
  initialInputs?: Partial<DealInputs>
  propertyLabel?: string
}

export function DealAnalyzerClient({ initialInputs, propertyLabel }: DealAnalyzerClientProps) {
        ...
        <div className="relative grid gap-6 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-center">
          <div className="space-y-3">
            <div className="inline-flex items-center gap-2 rounded-full border border-accent/20 bg-accent/10 px-3 py-1.5 text-2xs font-semibold uppercase tracking-[0.08em] text-accent">
              ...
              {propertyLabel ? 'Analyzing Property' : 'Investment Playground'}
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-ink-600">
                  {propertyLabel || 'Model flips, rentals, and wholesale exits with guided strategy feedback.'}
                </p>
              </div>
            </div>
          </div>
